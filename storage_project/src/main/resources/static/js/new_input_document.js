function addRow() {
    ...
    row.className = "update-line";

    const count = document.createElement("div");
    count.textContent = document.querySelectorAll(".update-line").length;
    // length + 1;
    count.className = "count";
    row.appendChild(count);

    const productsSelect = document.createElement("select");
    productsSelect.className = "doc-input";
    ...
    measureUnitsSelect.className = "doc-input";
    ...
    priceInput.className = "doc-input";
    priceInput.name = "docDetailsRows["+(count.textContent)+"].price";
