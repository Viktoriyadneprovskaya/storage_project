...
<div class="wrapper">
    ...
    <div class="block_center">
        <div class="bar">
            ...
            <h2 class="title-report">PRODUCTS SALES</h2>
            <br>
            ...
            <table class="table table-striped table-hover <%= request.getMethod().equals("POST") ? "" : "hidden" %>">
                <div <%= request.getMethod().equals("POST") ? "" : "hidden" %>><h2>Products sales from ${reportDates.startDate} to ${reportDates.endDate}</h2></div>
                <thead>
                <tr>
                    <th scope="col">#</th>
