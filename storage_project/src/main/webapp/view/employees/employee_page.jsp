...
<div class="wrapper">
    ...
    <div class="block_center">
        <div class="info-line">
            <button type="button" class="btn btn-secondary btn-lg" id="password-btn">Change password</button>
        ...
        <div <%= request.getMethod().equals("POST") && request.getRequestURI().endsWith("/change_password") ? "" : "hidden" %>>
            ${massage} </div>
        ...
        <div class="modal" id="modal">
            <div class="modal-form">
                ...
                <form action="/employee_page/change_password" method="post">
                    <div class="aline-form">
                        <div class="edge">Enter password
                            <input type="text" name="password" id="password-input" class="edge" placeholder="Password" required>
                        </div>
                        <div class="edge">Enter password
                            <input type="text" name="new_password" id="new-password-input" class="edge" placeholder=" New password" required>
                        </div>
                        <button type="submit" class="btn btn-light edge">Change</button>
                    </div>
                </form>
            </div>
        </div>
