...
<div class="wrapper">
  ...
  <div class="block_center">
    <div class="bar">
      ...
      <form:form action="/entire_document/update?document_id=${document.documentId}" method="post" modelAttribute="document">
      ...
      <div id="table" class="table">
        <C:forEach items="${document.docDetailsSelected}" var="docDetailsSelected"  varStatus="status">
          <input class="hidden-input" name="docDetailsSelected[${status.index}].id" value="${docDetailsSelected.id}">
          <div class="input-update-line">
            ...
            <input value="${docDetailsSelected.selectedQuantity}" class="doc-input" name="docDetailsSelected[${status.index}].quantities" required>
                <input value="${docDetailsSelected.price}" class="doc-input" name="docDetailsSelected[${status.index}].price" required>
