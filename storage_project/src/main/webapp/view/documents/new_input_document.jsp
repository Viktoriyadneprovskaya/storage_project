        ...
        <C:forEach items="${documentCommand.docDetailsRows}" var="docDetailsRow" varStatus="status">
          <div id="table" class="table">
            <div class="update-line">
              ...
              <input value="${docDetailsSelected.selectedQuantity}" class="doc-input" name="docDetailsRows[${status.index}].quantities" required>
                  <input class="doc-input" name="docDetailsRows[${status.index}].price" required>
            </div>
          </div>
        </C:forEach>
...
<script src="/js/documents/new_input_document.js"></script>
</body>
</html>
